package AutoDriveEditor.Classes.KDTree;
...
// 3D KD-Tree implementation for MapNode objects
//
//
...
public class KDTree3D {
    ...
    public MapNode withinRadius(double centerX, double centerY, double centerZ, double radius) {
        MapNode tempNode = createMapNode(-1, centerX, centerY, centerZ, MapNode.NODE_FLAG_REGULAR);
