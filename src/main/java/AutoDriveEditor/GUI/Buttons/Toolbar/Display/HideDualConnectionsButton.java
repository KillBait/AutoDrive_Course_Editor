...
public class HideDualConnectionsButton extends ConnectionSelectBaseButton {
    ...
    public HideDualConnectionsButton(JPanel panel) {
        ScaleAnimIcon animHideDualConnectionIcon = createScaleAnimIcon(BUTTON_VISIBILITY_CONNECT_DUAL_ICON, false);
        button = createAnimToggleButton(animHideDualConnectionIcon, panel, null, null,  false, false, this);
    }
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON3) {
            resetHiddenStatusForConnectionType(Connection.ConnectionType.DUAL);
            getMapPanel().repaint();
        }
    }
    ...
    public void onButtonSelect() {
        connectionTypeFilter = Connection.ConnectionType.DUAL;
    }
//
//    @Override
...
//            if (connection.getConnectionType() != Connection.ConnectionType.DUAL) {
//                iterator.remove();
//                continue;
//            }
